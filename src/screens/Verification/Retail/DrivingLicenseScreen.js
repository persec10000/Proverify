...
let self = null;
export default class DrivingLicenseScreen extends Component {
    ...
    render() {
        const {DLNumber,birth} = this.state;
        return (
            <KeyboardAwareScrollView style={styles.container}>
                <SafeAreaView style={styles.mainContainer}>
                    ...
                    <CustomTextInput 
                        ...
                        value={DLNumber}
                        onChangeText={this.onChangeDLNumber}
                    />
                    <Text style={styles.textStyle}>
                        Date of Birth
                    </Text>
                    <CustomTextInput 
                        ...
                        value={birth}
                        onChangeText={this.onChangeBirth}
                    />
